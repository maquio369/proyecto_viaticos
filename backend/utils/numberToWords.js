 ...
 * Específicamente para moneda (Pesos Mexicanos)
 */
...
/**
 * Formato específico para contabilidad mexicana: (PESOS 00/100 M.N.)
 */
function formatCurrencyMXN(num) {
...
module.exports = { numeroALetras, formatCurrencyMXN };
