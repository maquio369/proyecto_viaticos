...
const Login = ({ setUser }) => {
  ...
  return (
    <Box sx={{
      ...
      bgcolor: '#0f172a',
      backgroundImage: 'url("/img/patron-textil.webp")',
      ...
      {/* Top Bar */}
      <Box id="topBar" sx={{
        background: 'linear-gradient(180deg, rgba(9, 66, 49, 0.8) 0%, rgba(18, 104, 82, 0.9) 50%, rgba(8,88,66,1) 100%)',
        height: '54px',
        display: 'flex',
        ...
        <img
          alt="Logo SAG"
          src="/img/sag-007.svg"
          style={{ width: '68px', height: '19px', marginRight: '10px' }}
        />
        <span> · Sistema Administrativo Gubernamental</span>
      </Box>
          ...
          <Paper elevation={0} sx={{
            ...
            <Box component="form" onSubmit={handleSubmit} noValidate sx={{ width: '100%' }}>
              ...
              <Typography variant="body2" sx={{ color: '#64748b', textAlign: 'center', mt: 2, fontWeight: 500 }}>
                Oficina del Gobernador • <span style={{ color: '#334155' }}>Recursos Financieros</span>
              </Typography>
            </Box>
          </Paper>
        </Container>
